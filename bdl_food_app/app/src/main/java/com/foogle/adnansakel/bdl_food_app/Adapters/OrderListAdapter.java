...
public class OrderListAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(orderList.get(position).getBuyorSell().equals("Buy")){
            vholder.txtBuyFromorSellToID.setText("Bought from: "+orderList.get(position).getUserName());
        }
        else{
            vholder.txtBuyFromorSellToID.setText("Sold to: "+orderList.get(position).getUserName());
        }
